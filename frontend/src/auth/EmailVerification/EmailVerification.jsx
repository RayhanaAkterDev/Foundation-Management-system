...
const EmailVerification = () => {
    ...
    |--------------------------------------------------------------------------
    |
    | This status is used after the first login attempt of an
    | unverified real-email account.
    |
    | It is NOT limited to email changes.
    |
    */

    const isEmailVerificationRequired = status === 'email';
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Shown after first login when the account is still unverified.
    |
    */
                ...
                <section>
                    <div className="text-center">
                        ...
                        <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-slate-500 sm:text-[15px]">
                            Your account is not active yet. Please check your
                            email inbox and click the verification link to
                            activate your Stand For People account.
                        </p>
                    </div>

                    {email && (
                        <div className="mx-auto mt-6 flex max-w-md items-center justify-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-700">
                            <Mail
                                size={16}
                                strokeWidth={1.8}
                    ...
                    <div className="mx-auto mt-6 max-w-md border border-primary/10 bg-primary/5 px-4 py-4 text-left">
                    ...
                    {resendError && (
                        <div
                            role="alert"
                            className="mx-auto mt-4 flex max-w-md items-start gap-2 rounded-lg border border-red-100 bg-red-50 px-3.5 py-3 text-sm leading-5 text-red-700"
                        >
                            <CircleAlert
                                size={17}
                                strokeWidth={1.8}
                    ...
                    {resendMessage && (
                        <div
                            role="status"
                            className="mx-auto mt-4 flex max-w-md items-start gap-2 rounded-lg border border-primary/10 bg-primary/5 px-3.5 py-3 text-sm leading-5 text-primary"
                        >
                            <CheckCircle2
                                size={17}
                                strokeWidth={1.8}
                    ...
                    <form
                        ...
                        className="mx-auto mt-7 max-w-md border-t border-slate-200 pt-6 sm:mt-8 sm:pt-7"
                    >
                        <p className="mb-4 text-sm leading-6 text-slate-500">
                            Didn't receive the email? You can request another
                            verification email.
                        </p>
        ...
        return (
            <main className="mx-auto flex min-h-[60vh] w-full max-w-xl items-center justify-center px-4 py-10 sm:px-6 sm:py-14">
                <section className="w-full text-center">
                    ...
                    <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-slate-500 sm:text-[15px]">
                        {isDemoSuccess
                            ? 'Your demo account has been verified and is now active. You can sign in to continue.'
                            : 'Your email address has been verified and your Stand For People account is now active. You can sign in to continue.'}
                    </p>
