...
const inputBase =
    'h-12 w-full rounded-xl border border-[#e5e7eb] bg-white pl-10 pr-4 text-sm text-text-primary placeholder-[#6b7280] outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20';
        ...
        <div className="space-y-6">
            <div className="space-y-2">
                ...
                <p className="text-base text-[#6b7280]">
                    Help us understand your organization so we can verify and
                    support your work.
                </p>
            </div>
                    ...
                    >
                        <div className="relative">
                            ...
                            <select
                                ...
                                onChange={(e) =>
                                    onChange('organizationType', e.target.value)
                                }
