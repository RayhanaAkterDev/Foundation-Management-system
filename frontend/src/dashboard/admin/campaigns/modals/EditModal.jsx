        ...
        <div className="flex items-start justify-between border-b border-border px-6 py-5">
          <div>
            ...
            <p className="mt-1 text-sm text-text-secondary">
              Update campaign information without changing its lifecycle status.
            </p>
          </div>
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    disabled={loading}
                    required
                    className="h-11 w-full appearance-none rounded-lg border border-border bg-white px-3 pr-10 text-sm text-text-primary outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/10 disabled:cursor-not-allowed disabled:bg-background-alt">
