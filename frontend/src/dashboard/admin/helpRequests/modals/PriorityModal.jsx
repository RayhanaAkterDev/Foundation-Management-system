...
const PriorityModal = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/55 p-4 backdrop-blur-[5px] sm:p-6">
            ...
            <div className="relative z-10 flex max-h-[92vh] w-full max-w-135 flex-col overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-[0_30px_100px_rgba(15,23,42,0.24)]">
                {/* Header */}
                ...
                >
                            ...
                            {PRIORITIES.map((item) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {/* Selected accent */}
                                        <span
                                            className={`absolute bottom-0 left-0 right-0 h-0.75 transition-opacity ${
                                                item.color.accent
                                            } ${
                                                selected
                                                    ? 'opacity-100'
                    ...
                    <div className="flex items-center justify-end gap-3 border-t border-slate-100 bg-white px-6 py-4 sm:px-7">
                        ...
                        <button
                            ...
                            className="inline-flex h-10 min-w-27 items-center justify-center rounded-xl bg-primary px-5 text-sm font-semibold text-white shadow-sm transition-all hover:bg-primary-hover disabled:cursor-not-allowed disabled:opacity-50"
                        >
