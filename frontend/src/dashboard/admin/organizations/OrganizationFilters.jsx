            ...
            <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
                <div className="relative min-w-0 flex-1">
                    ...
                    <input
                        ...
                        placeholder="Search organizations by name or contact..."
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="relative">
                        <select
                            ...
                            className="h-11 min-w-40 appearance-none rounded-xl border border-border bg-white px-3.5 pr-9 text-sm font-medium text-text-primary outline-none transition-all hover:border-primary/30 focus:border-primary focus:ring-4 focus:ring-primary/8"
                        >
