...
const HelpRequestPageHeader = ({ onNewRequest, onExport, exportDisabled }) => (
    <section className="relative overflow-hidden rounded-2xl border border-primary/10 bg-[#edf4f4]">
        <div className="flex flex-col lg:flex-row">
            {/* Main Header */}
            <div className="relative flex min-w-0 flex-1 items-center overflow-hidden bg-primary px-6 py-8 sm:px-9 sm:py-10 lg:px-10 lg:py-11">
                {/* Decorative Elements */}
                <div className="pointer-events-none absolute -right-20 -top-24 h-64 w-64 rounded-full border-[28px] border-white/[0.035]" />
            ...
            {/* Quick Actions */}
            <div className="flex shrink-0 items-center border-t border-primary/10 bg-[#f4f8f8] px-6 py-6 sm:px-9 sm:py-7 lg:w-[340px] lg:border-l lg:border-t-0 lg:px-8">
                <div className="w-full min-w-0">
                    {/* Action Heading */}
                    <div className="mb-5">
                        <div className="flex items-center gap-2">
                            <span className="shrink-0 text-[10px] font-bold uppercase tracking-[0.16em] text-text-secondary">
                                Quick actions
                            </span>

                            <span className="h-px min-w-0 flex-1 bg-primary/10" />
                        </div>
        ...
        {/* Header Footer Strip */}
        <div className="flex min-h-16 items-center justify-between gap-4 border-t border-primary/10 bg-[#e8f1f1] px-6 py-4 sm:px-9 lg:px-10">
