...
import UrgencyBadge from "../bin/UrgencyBadge";
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-[10px] leading-5 text-[#78898d]">
              Review the case information before accepting or declining the
              assignment.
            </p>
          </div>
        </div>
      ...
      <div className="mb-8 border-l-[3px] border-[#0f766e] bg-[#f3f8f7] px-5 py-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-[10px] leading-5 text-[#78898d]">
              Your organization has accepted this case. Start support when your
              team is ready.
            </p>
          </div>
        </div>
...
const CommandAction = ({
  ...
  <button
    ...
    <div className="min-w-0 flex-1">
      ...
      <p className="mt-1 text-[9px] leading-5 text-[#8a979b]">{description}</p>
    </div>
...
const DrawerFooter = ({ request, onClose, onAction, actionLoading }) => {
  ...
  /*
   * Defensive support for pending.
   * Normal organization assignment flow starts at "assigned".
   */
      ...
      <div className="flex items-center justify-between border-t border-[#d8e1e2] bg-white px-7 py-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            onClick={() => onAction("decline")}
            disabled={actionLoading}
            className="h-9 border border-[#d3ddde] px-5 text-[10px] font-semibold text-[#59696f] transition hover:bg-[#f7f9f9] disabled:cursor-not-allowed disabled:opacity-50">
            Decline
          </button>
          ...
          <button
            ...
            onClick={() => onAction(request, "accept")}
            disabled={actionLoading}
            className="flex h-9 items-center gap-2 bg-[#0f766e] px-5 text-[10px] font-bold text-white transition hover:bg-[#115e59] disabled:cursor-not-allowed disabled:opacity-50">
            {actionLoading ? (
              <RotateCcw className="h-3.5 w-3.5 animate-spin" />
            ) : (
              <Check className="h-3.5 w-3.5" />
          ...
          <div className="flex h-14 items-center justify-between px-7">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[8px] text-white/40">Case review</span>
              </div>
            </div>
              ...
              <div className="min-w-0">
                ...
                <div className="mt-5 flex flex-wrap items-center gap-x-6 gap-y-2">
                  ...
                  <div className="flex items-center gap-1.5 text-[9px] text-white/45">
                    ...
                    {request.district || "Location not provided"}
                  </div>
                </div>
              </div>
          ...
          <main className="px-7 py-7">
            ...
            <section className="border-y border-[#d9e2e1] bg-white">
              <div className="grid grid-cols-4 divide-x divide-[#e0e6e5] px-5 py-5">
                <CaseFact label="Amount needed" value={amount} accent />

                <div className="pl-5">
                  <CaseFact
                    label="People affected"
                    value={request.peopleAffected || request.beneficiaries}
                  />
                </div>

                <div className="pl-5">
                  <CaseFact label="Category" value={request.category} />
                </div>

                <div className="pl-5">
                  <CaseFact
                    label="Support"
                    value={request.supportType || request.resourceType}
                  />
                </div>
              </div>

              <div className="grid grid-cols-3 border-t border-[#e0e6e5] px-5 py-4">
                <CaseFact label="District" value={request.district} />

                <div className="border-l border-[#e0e6e5] pl-5">
                  <CaseFact
                    label="Received"
                    value={request.createdAt || request.submittedAt}
                  />
                </div>
              ...
              <section className="mt-10">
                ...
                <div className="border-y border-[#d9e2e1] bg-white">
                  ...
                  <CommandAction
                    ...
                    danger
                    onClick={() => onRequestWithdrawal?.(request, "withdrawal")}
                    disabled={actionLoading}
                  />
                </div>
              </section>
