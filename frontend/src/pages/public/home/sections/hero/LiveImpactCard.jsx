...
const LiveImpactCard = () => {
    return (
        <div className="w-56 border border-border bg-surface p-4 rounded-2xl flex justify-between absolute right-105 top-35">
            <div className="flex flex-col">
                <Badge className='border-none bg-transparent! pl-0!' variant='primary' pulse dot >Help Delivered</Badge>
