        ...
        <section className="section-gap bg-white">
            <div className="container-width">
                ...
                <div className="mt-12 md:mt-16">
                    {/* KEY FIX: equal-height grid system */}
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-stretch">
                        ...
                        <article
                            ...
                            "
                        >
                            {/* FIX: stable aspect ratio instead of fixed height */}
                            ...
                            <div className="p-6 sm:p-7 lg:p-8 flex flex-col flex-1">
                                ...
                                <p className="mt-3 text-sm sm:text-base text-gray-700 leading-6 max-w-xl">
                                    Deliver food, medicine, and essential supplies
                                    directly to communities. Be present where help
                                    is needed most and create real impact.
                                </p>
                                <div className="mt-5 flex flex-col sm:flex-row gap-3 sm:gap-5 text-sm text-gray-600">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <TbClockHour4 className="text-gray-500" />
                                        Flexible timing
                                    </div>
                                </div>
                                <button className="mt-6 inline-flex items-center gap-2 text-emerald-700 font-medium w-fit hover:gap-3 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/40 rounded-md">
                        ...
                        <div className="md:col-span-5 flex flex-col gap-6 h-full">
                            {roles.map((role) => (
                                <article
                                    ...
                                    "
                                >
                                    <span className="w-fit text-xs px-3 py-1 rounded-full bg-gray-100 text-gray-700 border border-gray-200">
                                        {role.tag}
                                    </span>
                                    ...
                                    <button className="mt-5 inline-flex items-center gap-2 text-emerald-700 font-medium w-fit hover:gap-3 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/40 rounded-md">
                                        Learn More
                                        <TbArrowRight />
                                    </button>
                                </article>
